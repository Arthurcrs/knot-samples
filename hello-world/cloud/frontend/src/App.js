...
import {
  meshbluDefault, backendDefault, defaultFlags, eventFlag
} from './config';
...
const eventFlagTime = eventFlag.time;
const eventFlagChange = eventFlag.change;
...
class App extends Component {
  ...
  deviceConfig(deviceId) {
    ...
    axios.put(`/devices/${deviceId}/config`, {
      data: {
        flagTime: flagTime || defaultFlagTime,
        eventFlagsValue: eventFlagTime + (flagChange ? eventFlagChange : 0)
      }
    }, {
      headers: {
        'Meshblu-Host': host || meshbluDefaultHost,
